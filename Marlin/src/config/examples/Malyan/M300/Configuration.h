...
#define STRING_CONFIG_H_AUTHOR "(mcheah, Malyan M300 build)" // Who made the changes.
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_CALIBRATION_RADIUS 45 // mm
  ...
  #define DELTA_HEIGHT 125.0 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 63.00 //mm  Get this value from auto calibrate
